...
public class TestCassPayClient {
    ...
    public void init() throws InvalidPrivateKeyException, InvalidPublicKeyException {
        ...
        this.client = new DefaultCassPayClient("http://fuwu-openapi.skysharing.cn/gateway/cass", "12345H29GDK580CGNO30G81OEB", this.privateKeyStr, this.vzhuoPublicKeyStr, "JSON", "RSA2");
    }

    @Test
    public void testCreateDefaultClient() throws InvalidPrivateKeyException, InvalidPublicKeyException {
        new DefaultCassPayClient("http://fuwu-openapi.skysharing.cn/gateway/cass", "12345H29GDK580CGNO30G81OEB", this.privateKeyStr, this.vzhuoPublicKeyStr, "JSON", "RSA2");
        new DefaultCassPayClient("http://fuwu-openapi.skysharing.cn/gateway/cass", "12345H29GDK580CGNO30G81OEB", this.privateKeyStr, this.vzhuoPublicKeyStr);
    }
    ...
    @Test
    public void testJSONObjectToString() throws IOException {
        String name = "王孟臣";
        JSONObject user = new JSONObject();
        user.put("name", name);
        System.out.println(JSON.toJSONString(user, SerializerFeature.BrowserCompatible));
    }
}
